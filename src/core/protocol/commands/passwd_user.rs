...
/// The desired new password for a user, either provided explicitly,
/// generated by the server, or cleared.
...
mod tests {
    ...
    #[test]
    fn test_serialize_deserialize_clear_request() {
        let request: SetUserPasswordRequest = ("test_user".into(), PasswordSource::Clear);
